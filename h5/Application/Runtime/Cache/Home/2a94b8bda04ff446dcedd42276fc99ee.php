				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<section class="tiles">
								<?php if(is_array($res)): $k = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><article class="style<?php echo ($k); ?>">
									<span class="image">
										<img src="/Public/Home/images/pic0<?php echo ($k); ?>.jpg" alt="" />
									</span>
									<a href="/index.php/?s=home/index/generic/id/<?php echo ($k); ?>">

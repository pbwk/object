<?php
/* Smarty version 3.1.30, created on 2017-04-18 19:55:28
  from "/Users/apple/site/0418/0415/application/home/view/user/register.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58f5feb02489a5_26020305',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '138acb60103e7118915a19bbead04c6358d7bc09' => 
    array (
      0 => '/Users/apple/site/0418/0415/application/home/view/user/register.html',
      1 => 1492516489,
      2 => 'file',
    ),
  ),
...
function content_58f5feb02489a5_26020305 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
<?php echo '<script'; ?>
 type="text/javascript">
	...
	var G_BASE_URL = "?";
	var G_<?php echo PUBLIC_PATH;?>
home_URL = "<?php echo PUBLIC_PATH;?>
home";
...
home/css/default/img/login_logo.png"></a>
	...
	<div class="mod-body">
		<form id="register_form" method="post" action="?m=home&c=user&a=doRegisterAction" class="aw-register-form">

			<ul>
				<li class="alert alert-danger hide error_message text-left"> <i class="icon icon-delete"></i> <em></em>
				</li>
				<li>
					<input type="text" value="" errortips="用户名长度不符合" tips="请输入一个 2-14 位的用户名" placeholder="用户名" name="user_name" class="aw-register-name form-control"></li>
				<li>
					<input type="text" errortips="邮箱格式不正确" value="" tips="请输入你常用的电子邮箱作为你的账号" name="email" placeholder="邮箱" class="aw-register-email form-control"></li>
				<li>
					<input type="password" errortips="密码不符合规则" tips="请输入 6-16 个字符,区分大小写" placeholder="密码" name="password" class="aw-register-pwd form-control"></li>

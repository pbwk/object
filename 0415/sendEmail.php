...
$mail -> From = 'xiaobudian-066@163.com';	//发送者的邮件地址
$mail -> FromName = 'pbwk';		//发送邮件的用户昵称
$mail -> Username = 'xiaobudian-066';	//登录到163邮箱的用户名、账号
$mail -> Password = 'pbwk2017';	//第三方登录的授权码，在邮箱里面设置
...
//告诉服务器接收人的邮件地址
$mail -> AddAddress('348347651@qq.com');
//调用send方法，执行发送
$result = $mail -> Send();
